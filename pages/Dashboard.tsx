    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         ...
         <div className="lg:col-span-2 space-y-6">
            ...
            {/* A2. Critical Widget: Today's Appointments */}
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden relative transition-colors">
               ...
               <div className="p-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-indigo-50/30 dark:bg-indigo-900/10">
                  ...
                  <button onClick={() => onNavigate && onNavigate('appointments')} className="text-xs text-primary-600 dark:text-primary-400 font-bold hover:underline">عرض الجدول الكامل</button>
               </div>
               
               <div className="divide-y divide-slate-50 dark:divide-slate-700">
                  {todayAppointments.length > 0 ? todayAppointments.map(a => {
                     return (
                        <div key={a.id} className="p-4 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors flex items-center justify-between group">
                           <div className="flex items-center gap-4">
                              ...
                              <div>
                                 ...
                                 <p className="text-xs text-slate-500 dark:text-slate-400">{a.type === 'meeting' ? 'اجتماع' : a.type === 'client' ? 'مقابلة موكل' : 'موعد'}</p>
                              </div>
                           </div>
                        </div>
                     )
