...
import { Lawyer, BarLevelLabels } from '../types';
import { 
  ...
  const filteredLawyers = useMemo(() => {
    return lawyers.filter(l => {
      const matchesSearch = l.name.toLowerCase().includes(searchTerm.toLowerCase()) || 
                            ...
                            l.governorate.includes(searchTerm);
    ...
    <div className="space-y-6 animate-in fade-in pb-20">
      ...
      <div className="flex flex-col md:flex-row gap-4 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
        <div className="flex-1 relative">
          ...
          <input 
            type="text" 
            placeholder="بحث باسم المحامي، الهاتف، أو المحافظة..." 
            value={searchTerm}
          ...
          >
            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="space-y-2 text-sm text-slate-600 dark:text-slate-300">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>{lawyer.governorate} - {lawyer.office}</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono font-bold">{lawyer.salary.toLocaleString()} EGP</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-700/50 px-5 py-3 border-t border-slate-100 dark:border-slate-700 flex justify-between items-center text-xs">
              <span className="text-slate-500 dark:text-slate-400 flex items-center gap-1">
                <Calendar className="w-3 h-3" /> انضم: {lawyer.joinDate}
              </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={e => setFormData({...formData, barLevel: e.target.value as any})}
                  >
                    <option value="general">جدول عام</option>
